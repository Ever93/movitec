...
#  Nov 04, 2023 05:24:33 PM -0300  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1205x677+307+96
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    vTcl::widgets::ttk::scrolledtreeview::CreateCmd "$site_3_0.scr62" \
        -background $vTcl(actual_gui_bg) -height 300 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1025 
...
### SPOT dump_widget_opt A
        ...
        $base.lab52.scr62.01 column Col1 -width 214
        ...
        $base.lab52.scr62.01 column Col2 -width 116
        ...
        $base.lab52.scr62.01 column Col3 -width 120
        ...
        $base.lab52.scr62.01 column Col4 -width 137
...
### SPOT dump_widget_opt A
    ...
    label "$site_3_0.lab69" \
        ...
        -foreground #ff0000 -text "No existe producto" 
...
### SPOT dump_widget_opt A
    ...
    place $site_3_0.lab59 \
        -in $site_3_0 -x 0 -relx 0.566 -y 0 -rely 0.031 -width 0 \
        -relwidth 0.032 -height 0 -relheight 0.04 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab60 \
        -in $site_3_0 -x 0 -relx 0.602 -y 0 -rely 0.032 -width 0 \
        -relwidth 0.06 -height 0 -relheight 0.04 -anchor nw \
        -bordermode ignore 
    place $site_3_0.scr62 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.128 -width 0 \
        -relwidth 0.949 -height 0 -relheight 0.481 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.tCo50 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.659 -width 0 \
        -relwidth 0.272 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 0 -relx 0.352 -y 0 -rely 0.625 -width 0 \
        -relwidth 0.084 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent52 \
        -in $site_3_0 -x 0 -relx 0.824 -y 0 -rely 0.657 -width 154 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.625 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent54 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.657 -width 164 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.lab56 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.737 -width 0 \
        -relwidth 0.271 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab57 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.785 -width 0 \
        -relwidth 0.069 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab61 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.817 -width 0 \
        -relwidth 0.271 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab62 \
        -in $site_3_0 -x 0 -relx 0.352 -y 0 -rely 0.705 -width 0 \
        -relwidth 0.058 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab63 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.737 -width 0 \
        -relwidth 0.151 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab64 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.785 -width 0 \
        -relwidth 0.078 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab65 \
        -in $site_3_0 -x 0 -relx 0.352 -y 0 -rely 0.817 -width 0 \
        -relwidth 0.134 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab66 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.705 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab67 \
        -in $site_3_0 -x 0 -relx 0.824 -y 0 -rely 0.737 -width 0 \
        -relwidth 0.141 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tCo47 \
        -in $site_3_0 -x 0 -relx 0.352 -y 0 -rely 0.657 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tCo48 \
        -in $site_3_0 -x 0 -relx 0.352 -y 0 -rely 0.737 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.824 -y 0 -rely 0.705 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but51 \
        -in $site_3_0 -x 0 -relx 0.648 -y 0 -rely 0.817 -width 247 \
    ...
    place $site_3_0.lab68 \
        -in $site_3_0 -x 0 -relx 0.824 -y 0 -rely 0.625 -width 0 \
        -relwidth 0.059 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab69 \
        -in $site_3_0 -x 0 -relx 0.065 -y 0 -rely 0.079 -width 0 \
        -relwidth 0.146 -height 0 -relheight 0.034 -anchor nw \
        -bordermode ignore 
...
### SPOT dump_widget_opt A
    ...
    place $top.lab54 \
        -in $top -x 0 -relx 0.515 -y 0 -rely 0.016 -width 0 -relwidth 0.059 \
        -height 0 -relheight 0.049 -anchor nw -bordermode ignore 
