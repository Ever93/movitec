...
#  Nov 05, 2023 08:41:01 AM -0300  platform: Windows NT
set vTcl(timestamp) ""
...
### SPOT dump_widget_opt A
    labelframe "$top.lab52" \
        ...
        -background $vTcl(actual_gui_bg) -height 634 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1080 
...
### SPOT dump_widget_opt A
    ...
    entry "$site_3_0.ent57" \
        ...
        -selectforeground black -width 424 
...
### SPOT dump_widget_opt A
        ...
        $base.lab52.scr62.01 column #0 -width 394
        ...
        $base.lab52.scr62.01 column Col1 -width 94
        ...
        $base.lab52.scr62.01 column Col2 -width 161
        ...
        $base.lab52.scr62.01 column Col3 -width 166
        ...
        $base.lab52.scr62.01 column Col4 -width 94
        ...
        $base.lab52.scr62.01 heading Col5 -text {Acciones}
        $base.lab52.scr62.01 heading Col5 -anchor center
        $base.lab52.scr62.01 column Col5 -width 95
...
### SPOT dump_widget_opt A
    label "$site_3_0.lab56" \
        -activebackground #f9f9f9 -activeforeground #ffffff -anchor w \
...
### SPOT dump_widget_opt A
    label "$site_3_0.lab67" \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text "Mostrar total a pagar" 
    vTcl:DefineAlias "$site_3_0.lab67" "Label23" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::combobox "$site_3_0.tCo47" \
        -font "TkTextFont" -textvariable "combobox" -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$site_3_0.tCo47" "TCombobox2" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ttk::combobox "$site_3_0.tCo48" \
        -font "TkTextFont" -textvariable "combobox" -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$site_3_0.tCo48" "TCombobox3" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    label "$site_3_0.lab50" \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text "Total a Pagar" 
    vTcl:DefineAlias "$site_3_0.lab50" "Label24" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
...
### SPOT dump_widget_opt A
    label "$site_3_0.lab68" \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text "Descuento" 
    vTcl:DefineAlias "$site_3_0.lab68" "Label25" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    label "$site_3_0.lab69" \
        ...
        -highlightcolor black -text "No existe producto" 
    vTcl:DefineAlias "$site_3_0.lab69" "Label26" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    button "$site_3_0.but70" \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text "Historial" 
    vTcl:DefineAlias "$site_3_0.but70" "Button3" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
...
### SPOT dump_widget_opt A
    place $site_3_0.ent57 \
        -in $site_3_0 -x 0 -relx 0.065 -y 0 -rely 0.032 -width 424 \
    ...
    place $site_3_0.lab59 \
        ...
        -relwidth 0.04 -height 0 -relheight 0.039 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab60 \
        -in $site_3_0 -x 0 -relx 0.594 -y 0 -rely 0.032 -width 0 \
        -relwidth 0.07 -height 0 -relheight 0.039 -anchor nw \
        -bordermode ignore 
    place $site_3_0.scr62 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.126 -width 0 \
        -relwidth 0.949 -height 0 -relheight 0.48 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tSe47 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.632 -width 0 \
        -relwidth 0.949 -height 0 -relheight 0.003 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab49 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.664 -width 0 \
        -relwidth 0.086 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tCo50 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.695 -width 0 \
        -relwidth 0.272 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 0 -relx 0.362 -y 0 -rely 0.664 -width 0 \
        -relwidth 0.083 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent52 \
        -in $site_3_0 -x 0 -relx 0.826 -y 0 -rely 0.695 -width 154 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 0 -relx 0.575 -y 0 -rely 0.664 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent54 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.695 -width 164 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab55 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.742 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab56 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.774 -width 0 \
        -relwidth 0.271 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab57 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.821 -width 0 \
        -relwidth 0.069 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab61 \
        -in $site_3_0 -x 0 -relx 0.028 -y 0 -rely 0.853 -width 0 \
        -relwidth 0.271 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab62 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.742 -width 0 \
        -relwidth 0.058 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab63 \
        -in $site_3_0 -x 0 -relx 0.574 -y 0 -rely 0.774 -width 0 \
        -relwidth 0.151 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab64 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.821 -width 0 \
        -relwidth 0.078 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab65 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.853 -width 0 \
        -relwidth 0.134 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab66 \
        -in $site_3_0 -x 0 -relx 0.575 -y 0 -rely 0.742 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.019 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab67 \
        -in $site_3_0 -x 0 -relx 0.824 -y 0 -rely 0.773 -width 0 \
        -relwidth 0.141 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tCo47 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.695 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tCo48 \
        -in $site_3_0 -x 0 -relx 0.361 -y 0 -rely 0.774 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.826 -y 0 -rely 0.742 -width 0 \
        -relwidth 0.131 -height 0 -relheight 0.019 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but51 \
        -in $site_3_0 -x 0 -relx 0.648 -y 0 -rely 0.852 -width 247 \
        -relwidth 0 -height 34 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but52 \
        -in $site_3_0 -x 0 -relx 0.926 -y 0 -rely 0.032 -width 57 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab68 \
        -in $site_3_0 -x 0 -relx 0.826 -y 0 -rely 0.664 -width 0 \
        -relwidth 0.077 -height 0 -relheight 0.019 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab69 \
        -in $site_3_0 -x 0 -relx 0.065 -y 0 -rely 0.079 -width 0 \
        -relwidth 0.146 -height 0 -relheight 0.035 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but70 \
        -in $site_3_0 -x 0 -relx 0.861 -y 0 -rely 0.032 -width 57 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but47 \
        -in $site_3_0 -x 0 -relx 0.463 -y 0 -rely 0.032 -width 57 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    label "$top.lab53" \
        -activebackground #f9f9f9 -activeforeground SystemButtonText \
        -anchor w -background $vTcl(actual_gui_bg) -compound left \
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.lab47 \
        -in $top -x 0 -relx 0.017 -y 0 -rely 0.001 -width 0 -relwidth 0.046 \
        -height 0 -relheight 0.046 -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 0 -relx 0.1 -y 0 -rely 0.001 -width 0 -relwidth 0.044 \
        -height 0 -relheight 0.046 -anchor nw -bordermode ignore 
    place $top.lab49 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.001 -width 0 -relwidth 0.051 \
        -height 0 -relheight 0.046 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 0 -relx 0.266 -y 0 -rely 0.001 -width 0 -relwidth 0.056 \
        -height 0 -relheight 0.046 -anchor nw -bordermode ignore 
    place $top.lab52 \
        -in $top -x 0 -relx 0.058 -y 0 -rely 0.044 -width 0 -relwidth 0.895 \
        -height 0 -relheight 0.936 -anchor nw -bordermode ignore 
    place $top.lab53 \
        -in $top -x 0 -relx 0.349 -y 0 -rely 0.001 -width 0 -relwidth 0.061 \
        -height 0 -relheight 0.046 -anchor nw -bordermode ignore 
    place $top.lab51 \
        -in $top -x 0 -relx 0.432 -y 0 -rely 0.001 -width 0 -relwidth 0.051 \
        -height 0 -relheight 0.049 -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 0 -relx 0.515 -y 0 -rely 0.001 -width 0 -relwidth 0.059 \
        -height 0 -relheight 0.049 -anchor nw -bordermode ignore 
