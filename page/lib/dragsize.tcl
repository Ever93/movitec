...
proc vTcl:can_resize {dir} {
    ...
    if {$c in {Scale TScale TSeparator TProgressbar}} {
...
proc vTcl:actual_resize {widget newX newY newW newH handle} {
    ...
    if {$parent_class == "TPanedwindow"} {
        ...
        update idletasks
        set vTcl(skip) 1
    } elseif {$class in {Scale TScale TProgressbar}} {
        ...
        # This is the normal action for all widgets except paned
        # windows, scale widgets, progress bar widgets,or separator
        # widgets.
