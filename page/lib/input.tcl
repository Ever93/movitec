...
proc vTcl:string_window {title base {value ""}} {
    ...
    wm deiconify $base
    wm attributes $base -topmost 1       ;# Makes $base "Always on Top".
    wm title $base "$title"
    frame $base.fra19 \
...
proc vTcl:get_list {target} {
    # Initializes list boxes.
    global vTcl
    set base .vTcl.[vTcl:rename $target]
    vTcl:values_window $base "Set List Values" $target
}
...
proc vTcl:text_window {base title target {tooltip 0}} {
    ...
    # none added by Rozen and foreground 2-3-13
    text $base.cpd48.03 -width 8 -background $vTcl(area_bg) -wrap none \
