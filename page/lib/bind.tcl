...
#  vTcl(area_bg)  is the preferred background color
...
proc vTclWindow.vTcl.bind {args} {
    ...
    vTcl:DefineAlias $base.cpd21.01.cpd25.01 ListboxBindings \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.but24 RemoveBinding \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.men20 AddBinding \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.cpd21.02.cpd21.03 TextBindings \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.but25 MoveTagUp \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.but26 MoveTagDown \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.but27 AddTag \
        vTcl:WidgetProc BindingsEditor 1
    vTcl:DefineAlias $base.fra22.but28 DeleteTag \
        vTcl:WidgetProc BindingsEditor 1
    ...
    menu $base.m37.men38 -tearoff 0 \
        -postcommand \
  "vTcl:enable_entries $base.m37.men38 \$::widgets_bindings::uistate(AddBinding)"
    ...
    # but35 is an exit button
    ::vTcl::CancelButton $base.fra22.but35 \
        -command "destroy $base"
    vTcl:set_balloon $base.fra22.but35 "Exit and Close"
    ...
    vTcl:toolbar_menubutton $base.fra22.men20 \
        -image $image -menu $base.fra22.men20.m
    ...
    # ::vTcl::CancelButton $base.fra22.but24 \
        # -command "::widgets_bindings::delete_binding"
    set image [vTcl:light_or_dark_image minus]    ;# NEEDS WORK dark
    ...
    listbox $base.cpd21.01.cpd25.01 \
         -background $vTcl(area_bg) ;# This is ListboxBindings
	...
	# Right hand side aliased to TextBindings
    text $base.cpd21.02.cpd21.03 \
        ...
        #-background plum                      ;# NEEDS WORK dark
    ...
    frame $base.cpd21.03 \
        -background red -borderwidth 2 -highlightbackground #dcdcdc \
    ...
    # MoveTagUp     disabled   MoveTagDown   disabled ;# NEEDS WORK dark
...
proc vTclWindow.vTcl.newbind {base} {
    ...
    vTcl:DefineAlias $base.fra23.cpd34.01 BindingsModifiers \
        vTcl:WidgetProc BindingsInsert 1
    vTcl:DefineAlias $base.fra23.cpd35.01 BindingsEvents \
        vTcl:WidgetProc BindingsInsert 1
    vTcl:DefineAlias $base.fra36.ent38 BindingsEventEntry \
        vTcl:WidgetProc BindingsInsert 1
    ...
    #This is the left hand listbox in the advanced window. Rozen
    # listbox $base.fra23.cpd35.01
    listbox $base.fra23.cpd35.01 -background $vTcl(area_bg)   ;# NEEDS WORK dark
    ...
    # Unfortunately, that command misses <<ListboxSelect>> so I
    # try to pick it up below.
...
namespace eval ::widgets_bindings {
    ...
    proc {::widgets_bindings::set_uistate} {} {
        foreach name [array names ::widgets_bindings::uistate] {
            if {$name in {MoveTagUp MoveTagDown DeleteTag}} { continue }
    ...
    proc {::widgets_bindings::fill_bindings} {target {change 1}} {
        ...
        ::widgets_bindings::enable_toolbar_buttons
        ListboxBindings configure -background $vTcl(area_bg) ;# NEEDS WORK dark
    ...
    proc {::widgets_bindings::enable_editor} {enable} {
        ...
        switch $enable {
            1 - yes - true {
                ...
                ListboxBindings configure -background $vTcl(area_bg)
                if {$backup_bindings != ""} {
                    bindtags $widget(ListboxBindings) $backup_bindings
                }
                # $widget(AddTag) configure -state normal ;# NEEDS WORK dark
            }
            0 - no - false {
                ListboxBindings selection clear 0 end
                # ListboxBindings configure -background gray
                ListboxBindings configure \
                    -background $vTcl(area_bg) ;# NEEDS WORK dark
                ...
                TextBindings configure -background $vTcl(area_bg)
                ::widgets_bindings::enable_toolbar_buttons
                # $widget(AddTag) configure -state disabled;# NEEDS WORK dark
            }
        }
    }
    ...
    proc {::widgets_bindings::select_binding} {} {
        ...
        if {$tag == "" || $event == ""} {
            ...
            TextBindings configure  -state disabled -background $vTcl(area_bg)
            set ::widgets_bindings::lasttag ""
            set ::widgets_bindings::lastevent ""
            return
        }
    ...
    proc {::widgets_bindings::show_binding} {tag event} {
        ...
        if {[::widgets_bindings::is_editable_tag $tag] &&
            ...
            TextBindings configure  -background $vTcl(area_bg) -state normal
            ...
            # TextBindings configure  -background gray -state disabled
            TextBindings configure  -background $vTcl(area_bg) -state disabled
