...
proc vTcl:LoadWidget {lib file} {
    ...
    # processed by funny proc's at end of this module. They become
...
# It appears that CompoundCmd is never called!
...
proc ClassOption {args} {
    # This functions stores the special class options for later use.
